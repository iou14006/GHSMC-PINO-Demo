...
st.markdown("**Client:** GHSMC (積海半導體) | **Tech:** Skybit-PI")
...
with tab1:
    ...
    # pH 圖表
    fig_ph = go.Figure()
    fig_ph.add_trace(go.Scatter(x=t, y=pino_ph_target, mode='lines', name='Skybit-PI 理論值 (Physics)', line=dict(color='#00CC96', width=3, dash='dash')))
